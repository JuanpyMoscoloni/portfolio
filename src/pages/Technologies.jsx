...
export const Technologies = () => {
  ...
  function Element({ icon, name }) {
    return (
      <div className="flex w-full flex-col items-center justify-center rounded-2xl bg-white/30 border-2 border-transparent p-2 shadow-md hover:border-colorPage">
